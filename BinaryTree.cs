...

{
        ...
        where T : Dato
    {
        ...
        {
            BinaryTreeNode<Dato> node = (BinaryTreeNode< Dato > ) obj;
           
            if (this.Value.getFrecuencia() < node.Value.getFrecuencia())

            {
                return -1;
            }
            else if (this.Value.getFrecuencia() > node.Value.getFrecuencia())
            {
                return 1;
            }
            /*else if (this.Value.getSimbolo() < node.Value.getSimbolo())
            {
                return 1;
            }
            else if (this.Value.getSimbolo() > node.Value.getSimbolo())
